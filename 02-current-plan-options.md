...
- Route theme: Los Angeles arrival recovery, Pacific coast, San Francisco, Yosemite, and a Las Vegas city-resort finale before returning to LAX.
...
- Hardest route day: Yosemite to Las Vegas is the longest transfer in the selected loop. Keep it as a plain travel day unless live route timing makes a midpoint overnight necessary.
...
| Bay Area | San Francisco | 3 | Golden Gate, Alcatraz, Ferry Building, Presidio | 2-3 hours from Monterey/Carmel | Consider whether to keep the car parked, return it temporarily, or use hotels with manageable parking. |
| Sierra Nevada | Yosemite Valley or Fish Camp | 3 | Yosemite Valley, Glacier Point or Mariposa Grove | 4-5 hours from San Francisco | Book lodging early. July 11 arrival may still feel like peak-summer demand. |
...
| Los Angeles at both start and end | This satisfies the closed-circle requirement while preserving the coast, San Francisco, Yosemite, and Las Vegas. | Days 1-6 and 21 in `04-daily-itinerary.md`. |
...
| Two Monterey / Carmel nights | It keeps Monterey Bay Aquarium and a first Pacific coast taste while protecting time for San Francisco, Yosemite, and Las Vegas. | Days 9-10 in `04-daily-itinerary.md`. |
| Three San Francisco nights | This keeps Golden Gate and Alcatraz in the plan without forcing a long urban stay with costly parking. | Days 11-13 in `04-daily-itinerary.md`. |
...
| No-Yosemite route | It preserves the trip if Yosemite lodging is unavailable, badly priced, too crowded, or too hot for the family. | Use if July 11-14 Yosemite lodging or conditions are poor. |
...
| Mariposa Grove or Glacier Point on Yosemite Day 13 | Both are worthwhile, but road, shuttle, heat, and lodging location should decide the final choice. | Choose during the week-of Yosemite conditions check. |
| Central Valley / desert midpoint night between Yosemite and Las Vegas | It can make the hardest route day easier, but it costs one night from a major base. | Add only if live map timing, heat, or family energy makes the direct transfer too risky. |
| Hearst Castle on the Santa Barbara-to-Monterey transfer day | It can fit the coast move if tour timing and road conditions cooperate. | Book only if the Day 9 route remains comfortable. |
...
- The final LAX-area night protects the international departure but consumes one hotel night that could otherwise support San Francisco, the coast, or Las Vegas.
- San Francisco is now three nights instead of four. Keep Alcatraz and Golden Gate, but do not add Muir Woods by default.
...
| Highway 1 is usable but not frictionless: Caltrans reports one-way controlled traffic north of Big Sur through July 31, 2026 and near Jamala Road in Santa Barbara County due to a washout. | Caltrans | [Highway 1 road status](https://roads.dot.ca.gov/?roadnumber=1) | 2026-05-09 | Current; re-check before travel |
