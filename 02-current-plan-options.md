...
| Central Coast / Route 1 bridge | Cambria, San Simeon, Morro Bay, Pismo Beach, or San Luis Obispo | 1 | Scenic coast drive, small-town evening, optional elephant seals or Hearst Castle timing | 3.5-6 hours from Pasadena depending on CA-1 use and holiday traffic | Replaces Santa Barbara by traveler request. Use Route 1 where it is open and sensible; use US-101 as the fallback if traffic or road works make the coast too slow. |
| Central Coast North | Monterey / Carmel | 3 | Monterey Bay Aquarium, Pacific Grove, Carmel, 17-Mile Drive, short Big Sur reach | 3-6 hours from the Central Coast overnight depending on Highway 1 choice | The spare night from removing Santa Barbara is held here so the coast still has recovery margin after the scenic transfer. |
...
| One Central Coast / Route 1 overnight | It removes Santa Barbara, honors the Route 1 preference, and prevents a single overloaded Los Angeles-to-Monterey scenic day. | Day 7 in `04-daily-itinerary.md`. |
