...
## Instruction File Sync (Mandatory)

- `AGENTS.md` and `CLAUDE.md` must be kept identical at all times.
- Whenever you change either file, you must apply the exact same change to the other file in the same commit.
- Never let the two files drift. If they differ, reconcile them before committing.
