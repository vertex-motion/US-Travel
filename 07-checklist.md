...
| Does the family want a theme park day? | Disneyland or Universal would consume a full Los Angeles day and add crowd, cost, and height-rule constraints. | Decided: **California's Great America on Wednesday July 8 (Day 11)** — closest all-ages Bay Area park, chosen on a low-crowd weekday. LA Disneyland/Universal not taken (avoids a second park day). See [`research/theme-parks-bay-area.md`](research/theme-parks-bay-area.md). | Resolved |
