...
| Book Central Coast / Route 1 overnight lodging | Done | Travelers | Booked Historic Santa Maria Inn, Santa Maria, for July 4-5, 2026. Exact address, price, and booking reference are not recorded in this public repo. | Done |
...
| Book Mammoth Lakes lodging | Done | Travelers | Booked Outbound Mammoth, Mammoth Lakes, for July 13-14, 2026. Booking PIN, exact address, payment details, contact details, and private traveler details are not recorded in this public repo. | Done |
...
| Stanford campus visit | Done | Visited July 7 (Day 10) — self-guided campus walk on the Mountain View arrival afternoon. | Done |
| Google Visitor Experience | Done | Visited Day 13 (July 10, 2026) — Google Store, cafe, public art, and self-guided exploration. | Done |
| Confirm Day 13 tech-stop hours | Done | Day 13 (July 10, 2026) visited: Apple Park Visitor Center, Google Visitor Experience, and Computer History Museum. | Done |
...
| Inflatable kids' leg-rest cushion — airline policy | Done | Decided: do not pack one. United prohibits inflatable footrest / leg-rest cushions (Fly Tot, Plane Pal, JetKids BedBox) as a seat alteration that impedes emergency egress. Use an approved travel pillow and the child's own seat on the LAX–SYD legs (UA 842 / UA 839). Full write-up in [`research/inflatable-kids-leg-rest-cushion-airline-policy.md`](research/inflatable-kids-leg-rest-cushion-airline-policy.md). | Done |
| Measure the 3-year-old's height (in inches) | Done | Measured **~105 cm (~41¼″)**. She **clears the 40″ (102 cm) tier** but is **~2 cm short of 42″ (107 cm)**: at Great America she rides all of Planet Snoopy incl. the 40″ Woodstock Express; at Disneyland she rides the 40″ headliners with the teen (Space Mountain, Big Thunder, Star Tours, Rise of the Resistance); at Universal she clears Mario Kart/Transformers/Hippogriff. Re-check at the gate in **thick-soled sneakers** (the 42″ line is close). | Done |
| Drone: confirm exact model and Remote ID status | Before packing the drone | Confirm whether the aircraft is a DJI Air 2S or DJI Mavic 2 Pro. Update the aircraft, controller, and DJI app. Verify the Remote ID serial appears in the app. If Remote ID cannot be confirmed, leave the drone home. See [California drone rules research](Research/california-drone-rules-dji-2s-pro.md). | Open |
| Drone: complete FAA recreational setup | Before departure | Register the drone in FAA DroneZone, add the Remote ID serial, mark the FAA registration number on the drone exterior, take TRUST, and save registration + TRUST proof offline on the phone. | Open |
| Drone: install and test U.S. airspace tools | Before departure | Install an FAA-approved B4UFLY / LAANC app, confirm login works, and test sample pins for Pasadena, Monterey, Mountain View, San Francisco, Mammoth Lakes, Death Valley, Las Vegas, and LAX. Treat national parks, LA city parks, SF Rec & Park land, World Cup areas, wildlife areas, and emergency scenes as no-drone unless current rules clearly allow the flight. | Open |
| Drone: confirm airline battery packing | Before packing | Check United and FAA lithium-battery rules for the exact drone batteries. Pack spare batteries in carry-on only, protect terminals from short circuit, keep damaged/swollen batteries out of luggage, and keep battery proof/rules handy for airport screening. | Open |
...
| Caltech self-guided walk prep (Day 5) | Done | Visited Day 5 (July 2, 2026): evening self-guided campus walk after 5:00 pm (free parking). Outdoor grounds only; no booking. | Done |
...
| --- | --- | --- | --- |
| Which Silicon Valley tech stops should anchor Day 13? | Stanford was visited early on Day 10, so Day 13 is now a pure tech day and should not try to cover every company campus. | Resolved: Day 13 (July 10, 2026) visited Apple Park Visitor Center (Cupertino), Google Visitor Experience, and the Computer History Museum (both Mountain View). | Resolved |
...
| Which theme park(s) to visit? | Park and ride choices depend on crowds, cost, a second-park-day tradeoff, and the 3-year-old's height (now measured at ~105 cm / 41¼″ — clears 40″, just under 42″). | Decided: **California's Great America on Wednesday July 8 (Day 11)** — closest all-ages Bay Area park, chosen on a low-crowd weekday; at ~105 cm she rides all of Planet Snoopy incl. the 40″ Woodstock Express. **Universal Studios Hollywood not taken** — note the height now makes it more viable (she clears Mario Kart/Transformers/Hippogriff), so it is revisitable if the teen prioritizes it, but it stays out for July crowds and the two-park-day cost. LA Disneyland also not taken. See [`research/theme-parks-bay-area.md`](research/theme-parks-bay-area.md) and [`research/theme-parks-los-angeles.md`](research/theme-parks-los-angeles.md). | Resolved |
| Which one Las Vegas paid indoor attraction or show should be the anchor? | Las Vegas has many paid options, but booking several would raise cost and reduce flexibility in July heat. | Resolved: **Omega Mart (Meow Wolf at AREA15)**, visited Day 18 (July 15, 2026) as the paid anchor. Shark Reef, Blue Man Group, and Madame Tussauds not used. | Resolved |
...
| Outbound Mammoth is booked in Mammoth Lakes from July 13 to July 14, 2026, with check-in from 4:00 pm and checkout until 11:00 am. Free cancellation runs until July 10, 2026 at 23:59 PDT. | Traveler booking | User-provided Mammoth Lakes hotel booking details | 2026-06-06 | Booked; booking PIN, exact address, payment details, contact details, and private traveler details intentionally omitted |
...
| Mariposa Grove shuttle hours and Glacier Point road access are seasonal and condition-dependent. | National Park Service | [Mariposa Grove](https://www.nps.gov/yose/planyourvisit/mg.htm) and [Glacier Point](https://www.nps.gov/yose/planyourvisit/glacierpoint.htm) | 2026-05-31 | Current; one-night Yosemite plan is Valley-first |
...
| Drone setup and California no-drone / permission-first rules for the DJI Air 2S or DJI Mavic 2 Pro-class drone. | Local research file | [Research/california-drone-rules-dji-2s-pro.md](Research/california-drone-rules-dji-2s-pro.md) | 2026-06-26 | Current; re-check before packing and before each flight |
| Spare lithium-ion batteries must be carry-on only, protected from damage and short circuit, and limited by watt-hour rules; larger spares require airline approval. | FAA | [Airline Passengers and Batteries](https://www.faa.gov/hazmat/packsafe/airline-passengers-and-batteries) | 2026-06-26 | Current; re-check before packing |
| TSA allows drones through the checkpoint but warns that drones with lithium batteries may be prohibited in baggage; passengers should check airline policy before travel. | TSA | [Drones, Unmanned Aircraft Systems (UAS)](https://www.tsa.gov/travel/security-screening/whatcanibring/items/drones-unmanned-aircraft-systems-uas) | 2026-06-26 | Current; re-check before packing |
