...
| --- | --- | --- | --- |
| Which Silicon Valley tech stops should anchor Day 13? | Stanford was visited early on Day 10, so Day 13 is now a pure tech day and should not try to cover every company campus. | Day 13 anchors on Google Visitor Experience plus Computer History Museum; use Apple Park Visitor Center or The Tech Interactive as swaps. | Open |
