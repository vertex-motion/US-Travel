...
| Measure the 3-year-old's height (in inches) | Before travel | Measure standing height in inches; it sets which theme-park rides she clears. Key thresholds: most Great America Planet Snoopy rides have low or no minimum, but some need **36″** or **42″**; Universal's marquee rides need **40″–48″**. Record the number to plan rider swap and ride choices on the Day 11 Great America visit. | Open |
