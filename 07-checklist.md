...
| Does the family want a theme park day? | Disneyland or Universal would consume a full Los Angeles day and add crowd, cost, and height-rule constraints. | Default: skip — nothing depends on it. If the family wants one, do a single **Disneyland** weekday (Tue June 30 or Wed July 1), ~$600–700; it is the only park that suits the 3- and 13-year-old together (Universal's marquee rides are 40″+, shutting out the 3-year-old). See [`research/theme-parks-los-angeles.md`](research/theme-parks-los-angeles.md). | Open |
