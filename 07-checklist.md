...
| Confirm rental car operating details | Before pickup | Confirm vehicle class, luggage fit, child seat plan, second driver, fuel policy, toll handling, additional driver fees, Australian license / IDP requirements, and counter timing. | Open |
...
| Will the family bring or rent the younger child's car seat? | It affects airport transfers, airline logistics, rental car pickup, and vehicle fit. | Bring a known approved seat if airline and rental logistics allow. | Open |
