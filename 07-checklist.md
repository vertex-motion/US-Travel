...
| Confirm Day 13 tech-stop hours | Week before Bay Area stay | Apple Park Visitor Center, Google Visitor Experience, and Computer History Museum are all on Day 13 — check each one's hours, sessions, and CHM tickets. | Open |
...
| --- | --- | --- | --- |
| Which Silicon Valley tech stops should anchor Day 13? | Stanford was visited early on Day 10, so Day 13 is now a pure tech day and should not try to cover every company campus. | Day 13 clusters Apple Park Visitor Center (Cupertino), Google Visitor Experience, and the Computer History Museum (both Mountain View); The Tech Interactive stays a swap. | Open |
