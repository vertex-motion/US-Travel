...
- `02-current-plan-options.md`: selected route, included options, retained alternatives, and route tradeoffs.
- `03-potential-options.md`: parked routes, attractions, logistics, or lodging ideas with reconsideration triggers.
