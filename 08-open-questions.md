...
Use source rows in `03-potential-options.md`, `04-daily-itinerary.md`, `05-trip-logistics.md`, and `07-checklist.md` for supporting facts. Do not duplicate those source tables here unless a new open decision needs evidence that is not already stored in its canonical file.
