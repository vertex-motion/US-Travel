...
| --- | --- | --- |
| Is July 1-20, 2026 the correct Sydney-to-Sydney window? | It fixes the number of US hotel nights and whether San Diego can fit. | Use July 1-20 for the first quote round. |
| Is the family willing to arrive Sydney on July 21 instead of July 20? | One extra night makes San Diego or more recovery time easier, but the new driving tolerance means it is not needed just to soften transfers. | Extend only if San Diego is a must. |
...
- Current Highway 1 status for the Monterey-Big Sur-Hearst Castle plan.
...
| Yosemite should remain conditional on lodging and current entry/fee rules. | National Park Service | [Yosemite reservations](https://www.nps.gov/yose/planyourvisit/reservations.htm) | 2026-05-08 | Current |
