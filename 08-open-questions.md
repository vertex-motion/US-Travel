...
| --- | --- | --- |
| Is July 1-20, 2026 the correct Sydney-to-Sydney window? | It fixes the number of US hotel nights and whether any extra recovery time can fit. | Use July 1-20 for the first quote round. |
| Is LAX definitely the closed-circle start and end airport? | It shapes all flights, car rental, first/last hotel choices, and the route order. | Use LAX unless live quotes strongly favor another closed-circle gateway. |
| Should the rental car start on Day 1 or Day 4? | Day 1 is simpler for one rental contract; Day 4 may avoid LA parking during arrival recovery. | Choose after the first LA hotel base and parking cost are known. |
...
| Should Red Rock Canyon be included in Las Vegas? | It adds a desert nature moment, but July heat makes it only an early-morning option. | Keep it optional for Day 16, not a fixed booking. |
...
- Exact SYD-LAX-SYD airfare for July 1 departure and July 18 return.
- Exact comparison quote for SFO-SFO and LAS-LAS only if LAX fares or times are poor.
...
- Rental car comparison quote for Day 1 pickup versus Day 4 pickup.
...
- LAX terminal, rental car return, and departure-day transfer timing after flights are booked.
...
- The family can handle longer intercity transfer days, but still prefers fewer hotel changes over adding San Diego or Grand Canyon inside the 20-day plan.
